...
namespace FileSync.Common
{
        ...
        */
        ...
        private struct InputTextStream
        {
            ...
            public int Position
            {
                ...
                {
                    _position = value;
                    _endOfStream = _position >= _length;
                }
            }
            ...
            public uint ReadUInt32()
            {
                ...
                var value = BitConverter.ToUInt32(_data, Position);
                Skip(4);
                return value;
            }
            ...
            public ulong ReadUInt64()
            {
                ...
                var value = BitConverter.ToUInt64(_data, Position);
                Skip(8);
                return value;
            }
            ...
            public bool Skip(int skipNumBytes)
            {
                ...
                if (!_endOfStream)
                {
                    if (Position + skipNumBytes > _length)
                    {
                        Position = _length;
                    }
                    else
    ...
    public abstract class XXHash32 : HashAlgorithm
    {
        ...
        public static XXHash32 Create(int seed)
        {
            return new XXHash32CryptoServiceProvider(seed);
        }

        public static XXHash32 Create(uint seed)
        {
            return new XXHash32CryptoServiceProvider(seed);
        }
    }
    ...
    public sealed class XXHash32CryptoServiceProvider : XXHash32
    {
        ...
        {
            var value = XXHash.InternalDigestState32(_state);
    ...
    public abstract class xxHash64Algo : HashAlgorithm
    {
        protected xxHash64Algo()
        {
            HashSizeValue = 0x40;
        }

        public new static xxHash64Algo Create()
        {
            return new XxHash64AlgoCryptoServiceProvider(0);
        }

        public static xxHash64Algo Create(long seed)
        {
            return new XxHash64AlgoCryptoServiceProvider(seed);
        }

        public static xxHash64Algo Create(ulong seed)
        {
            return new XxHash64AlgoCryptoServiceProvider(seed);
        }
    }

    public sealed class XxHash64AlgoCryptoServiceProvider : xxHash64Algo
    {
        private XXHash.State64 _state;

        public XxHash64AlgoCryptoServiceProvider()
            : this(0)
        {
        }

        public XxHash64AlgoCryptoServiceProvider(long seed)
        {
        ...
        public XxHash64AlgoCryptoServiceProvider(ulong seed)
        ...
        protected override byte[] HashFinal()
        {
            var value = XXHash.InternalDigestState64(_state);
            return BitConverter.GetBytes(value);
        }
